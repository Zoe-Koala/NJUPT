	...
	while (true)
	{
		...
		case WM_RBUTTONUP:
			...
			else if (Times > 1)
			{
				...
				if ((position[Times - 2][1] < 0) && (height / 2 + 250 - (-position[Times - 2][1] * 5 + height / 2) <= step_length))//x下方
					line(position[Times - 2][0] * 5 + width / 2, -position[Times - 2][1] * 5 + height / 2, position[Times - 2][0] * 5 + width / 2, height / 2 + 250);
				else if ((position[Times - 2][1] >= 0) && ((-position[Times - 2][1] * 5 + height / 2) - (height / 2 - 250) <= step_length))//x上方
					line(position[Times - 2][0] * 5 + width / 2, -position[Times - 2][1] * 5 + height / 2, position[Times - 2][0] * 5 + width / 2, height / 2 - 250);
				else if ((position[Times - 2][0] >= 0) && (width / 2 + 250 - (position[Times - 2][0] * 5 + width / 2) <= step_length))//y右方
					line(position[Times - 2][0] * 5 + width / 2, -position[Times - 2][1] * 5 + height / 2, width / 2 + 250, -position[Times - 2][1] * 5 + height / 2);
				else if ((position[Times - 2][0] < 0) && ((position[Times - 2][0] * 5 + width / 2) - (width / 2 - 250)) <= step_length)//y左方
				    line(position[Times - 2][0] * 5 + width / 2, -position[Times - 2][1] * 5 + height / 2, width / 2 - 250, -position[Times - 2][1] * 5 + height / 2);
